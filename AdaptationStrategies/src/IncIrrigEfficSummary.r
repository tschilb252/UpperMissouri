...
ggsave(paste0(dirOup, 'IncIrrigEfficGrid2050s.png'), height = 10, width = 8)
...
ggsave(paste0(dirOup, 'IncIrrigEfficGrid2080s.png'), height = 10, width = 8)
write.csv(datMeasPlot, paste0(dirOup, 'IncIrrigEfficGrid2080s.csv'),
  row.names = F, quote = F)
