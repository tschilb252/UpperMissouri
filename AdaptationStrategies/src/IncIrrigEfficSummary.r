...
ggsave(paste0(dirOup, 'IncIrrigEfficGrid2050s.png'), height = 7.5, width = 3)
write.csv(datMeasPlot, paste0(dirOup, 'IncIrrigEfficGrid2050s.csv'),
  row.names = F, quote = F)
  ...
  ggsave(paste0(dirOup, 'IncIrrigEfficGridHistorical.png'), height = 7.5, width = 3)
  ...
  ggsave(paste0(dirOup, 'IncIrrigEfficGridBaseline2050s.png'), height = 7.5, width = 3)
  ...
  ggsave(paste0(dirOup, 'IncIrrigEfficGrid2080s.png'), height = 7.5, width = 3)
  write.csv(datMeasPlot, paste0(dirOup, 'IncIrrigEfficGrid2080s.csv'), row.names = F, quote = F)
  ...
  ggsave(paste0(dirOup, 'IncIrrigEfficGridBaseline2080s.png'), height = 7.5, width = 3)
